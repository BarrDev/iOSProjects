    ...
    var body: some View {
        VStack {
            Text("Address Book")
                ...
                .padding()                               
            Spacer()
            ContactsView().environmentObject(viewModel) //TODO: ENVIRONMENTOBJECT - Pass the viewModel to the ContactsView
            Spacer()
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        AddressBookView().environmentObject(AddressBookViewModel())
    }
}
